...
exports.LOG_LEVEL = exports.LitNamespace = exports.LIT_NAMESPACE = exports.LitRecapAbility = exports.LIT_RECAP_ABILITY = exports.LitAbility = exports.LIT_ABILITY = exports.LitResourcePrefix = exports.LIT_RESOURCE_PREFIX = exports.RelayAuthStatus = exports.RELAY_AUTH_STATUS = exports.StakingStates = exports.STAKING_STATES = exports.ProviderType = exports.PROVIDER_TYPE = exports.AuthMethodScope = exports.AUTH_METHOD_SCOPE = exports.AuthMethodType = exports.AUTH_METHOD_TYPE = exports.EITHER_TYPE = exports.LIT_CURVE = exports.VMTYPE = exports.LIT_ACTION_IPFS_HASH = exports.SIWE_DELEGATION_URI = exports.PKP_CLIENT_SUPPORTED_CHAINS = exports.AUTH_METHOD_TYPE_IDS = exports.LIT_SESSION_KEY_URI = exports.LIT_NETWORKS = exports.SYMM_KEY_ALGO_PARAMS = exports.LOCAL_STORAGE_KEYS = exports.ALL_LIT_CHAINS = exports.LIT_COSMOS_CHAINS = exports.LIT_SVM_CHAINS = exports.CENTRALISATION_BY_NETWORK = exports.HTTP_BY_NETWORK = exports.HTTPS = exports.HTTP = exports.METAMASK_CHAIN_INFO_BY_NETWORK = exports.RELAYER_URL_BY_NETWORK = exports.RPC_URL_BY_NETWORK = exports.LitNetwork = exports.LIT_NETWORK = exports.LIT_EVM_CHAINS = exports.LIT_RPC = exports.metamaskChainInfo = exports.METAMASK_CHAIN_INFO = exports.LIT_CHAINS = exports.AUTH_SIGNATURE_BODY = exports.LIT_AUTH_SIG_CHAIN_KEYS = exports.NETWORK_PUB_KEY = void 0;
exports.FALLBACK_IPFS_GATEWAYS = exports.LogLevel = void 0;
const tslib_1 = require("tslib");
const depd_1 = tslib_1.__importDefault(require("depd"));
const deprecated = (0, depd_1.default)('lit-js-sdk:constants:constants');
/**
...
exports.METAMASK_CHAIN_INFO = {
     ...
     */
    yellowstone: {
        chainId: exports.LIT_CHAINS['yellowstone'].chainId,
        chainName: exports.LIT_CHAINS['yellowstone'].name,
        nativeCurrency: {
            name: exports.LIT_CHAINS['yellowstone'].symbol,
            symbol: exports.LIT_CHAINS['yellowstone'].symbol,
            decimals: exports.LIT_CHAINS['yellowstone'].decimals,
        },
        rpcUrls: exports.LIT_CHAINS['yellowstone'].rpcUrls,
        blockExplorerUrls: exports.LIT_CHAINS['yellowstone'].blockExplorerUrls,
        iconUrls: ['future'],
    },
};
/**
 ...
 */
exports.metamaskChainInfo = new Proxy(exports.METAMASK_CHAIN_INFO, {
 ...
 */
exports.LitNetwork = new Proxy(exports.LIT_NETWORK, {
    get(target, prop, receiver) {
...
exports.RPC_URL_BY_NETWORK = {
    'datil-dev': exports.LIT_RPC.CHRONICLE_YELLOWSTONE,
 ...
 */
exports.RELAYER_URL_BY_NETWORK = {
 ...
 */
exports.METAMASK_CHAIN_INFO_BY_NETWORK = {
    'datil-dev': exports.METAMASK_CHAIN_INFO.yellowstone,
    'datil-test': exports.METAMASK_CHAIN_INFO.yellowstone,
    datil: exports.METAMASK_CHAIN_INFO.yellowstone,
    custom: exports.METAMASK_CHAIN_INFO.yellowstone,
};
exports.HTTP = 'http://';
exports.HTTPS = 'https://';
/**
 ...
 */
exports.CENTRALISATION_BY_NETWORK = {
...
// ========== RLI Delegation ==========
exports.SIWE_DELEGATION_URI = 'lit:capability:delegation';
// ========== Lit Actions ==========
 ...
 */
exports.AuthMethodType = new Proxy(exports.AUTH_METHOD_TYPE, {
    get(target, prop, receiver) {
 ...
 */
exports.AuthMethodScope = new Proxy(exports.AUTH_METHOD_SCOPE, {
    get(target, prop, receiver) {
 ...
 */
exports.ProviderType = new Proxy(exports.PROVIDER_TYPE, {
    get(target, prop, receiver) {
 ...
 */
exports.StakingStates = new Proxy(exports.STAKING_STATES, {
    get(target, prop, receiver) {
 ...
 */
exports.RelayAuthStatus = new Proxy(exports.RELAY_AUTH_STATUS, {
    get(target, prop, receiver) {
 ...
 */
exports.LitResourcePrefix = new Proxy(exports.LIT_RESOURCE_PREFIX, {
    get(target, prop, receiver) {
 ...
 */
exports.LitAbility = new Proxy(exports.LIT_ABILITY, {
    get(target, prop, receiver) {
 ...
 */
exports.LitRecapAbility = new Proxy(exports.LIT_RECAP_ABILITY, {
    get(target, prop, receiver) {
 ...
 */
exports.LitNamespace = new Proxy(exports.LIT_NAMESPACE, {
    get(target, prop, receiver) {
 ...
 * See {@link LOG_LEVEL}
 */
exports.LogLevel = new Proxy(exports.LOG_LEVEL, {
    get(target, prop, receiver) {
