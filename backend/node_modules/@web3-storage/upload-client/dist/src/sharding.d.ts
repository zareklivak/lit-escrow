 ...
 */
export class ShardingStream extends TransformStream<import("@ipld/unixfs").Block<any, number, number, import("@ipld/dag-ucan").LinkVersion>, import("./types.js").IndexedCARFile> {
    /**
